  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 bg-gradient-to-br from-black via-yellow-500 to-white">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 right-10 w-32 h-32 bg-yellow-400/30 rounded-full animate-pulse"></div>
        <div className="absolute bottom-20 left-10 w-48 h-48 bg-black/30 rounded-full animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-white/30 rounded-full animate-pulse delay-500"></div>
      </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 backdrop-blur-sm border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-right">
              <Link 
                to="/forgot-password" 
                className="text-sm text-black hover:text-gray-800 hover:underline font-semibold"
              >
